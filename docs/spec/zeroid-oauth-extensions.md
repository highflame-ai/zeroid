...
event types, and non-standard endpoints. It is the normative reference an
...
10. [Non-Standard Endpoints](#10-non-standard-endpoints)
...
the `parent_jti` edges via the Delegation Explorer (Section 10.1) rather than by
nesting.
